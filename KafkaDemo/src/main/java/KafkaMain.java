...
public class KafkaMain {
    public static void main(String[] args) throws IOException, InterruptedException, ExecutionException {
        ...
        kafkaProperties.put("bootstrap.servers", "macmini:9092");
...
//    public static void sendCSVMessage(Producer producer, int messageBatch, String delimiter) throws JsonProcessingException, InterruptedException {
//        ObjectMapper mapper = new ObjectMapper();
//        String[] levels = {"VH","H","N","L"};
//        Random random = new Random();
//
...
//            record.append(delimiter);
//            record.append(event.getMates().stream().map(e -> "'"+e+"'").collect(Collectors.toList()).toString());
//
//            ProducerRecord<Long, String> kafkaRecord = new ProducerRecord<Long, String>("clickhouse_csv_hehe_111", record.toString());
